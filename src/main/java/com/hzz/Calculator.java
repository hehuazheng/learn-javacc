...
public class Calculator implements CalculatorConstants {
 ...
 parser.parse();
  ...
  final public double parse() throws ParseException {double result;
...
/**二元运算**/
  final public double binaryOperation() throws ParseException {double result;
 double tmp;
...
/**二元运算中高优先级的部分**/
  final public double binaryOperationHighPriority() throws ParseException {double result;
 double tmp;
...
/**�?元运�?**/
  final public double unaryOperation() throws ParseException {double result;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 8:{
      jj_consume_token(8);
      result = element();
...
{if ("" != null) return result;}
  ...
  final public double element() throws ParseException {Token token;
 double result;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NUMBER:{
      token = jj_consume_token(NUMBER);
{if ("" != null) return Double.parseDouble(token.toString());}
      break;
      }
    case 11:{
      jj_consume_token(11);
